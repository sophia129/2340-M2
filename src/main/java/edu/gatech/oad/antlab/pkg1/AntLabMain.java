 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Sophia Yan");
		  toPrint += p1.toString("syan61");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Anum Bhamani");
		  toPrint += p2.toString("abhamani6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Viren Sabhnani"); //this comment is for testing
		  toPrint += p3.toString("vsabhnani3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Kyle Keirstead");
          toPrint += p4.toString("kkeirstead3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id

          Person5 p5 = new Person5("Frank Zhou");
